...
public class Tab03Fragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,LoadMoreListView.OnLoadMore{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mview=LayoutInflater.from(getActivity()).inflate(R.layout.fragment_tab03,null);
    ...
    private void initView() {
        ...
        swipeRefreshLayout= (SwipeRefreshLayout) mview.findViewById(R.id.tab03_swipe_ly);
        swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light,
                android.R.color.holo_red_light, android.R.color.holo_orange_light,
                android.R.color.holo_green_light);
        swipeRefreshLayout.setOnRefreshListener(this);
        mListView= (LoadMoreListView) mview.findViewById(R.id.tab03_lv);
...
//                    ShowToast.show(getActivity(), "更新数据成功！");
                ...
                case GETJOKE_FAIL:
                    ...
                    ShowToast.show(getActivity(), "没有最新啦!休息一下~~");
                    break;
...
//                    ShowToast.show(getActivity(), "加载数据成功！");
                ...
                case LOADMORE_GETJOKE_FAIL:
                    mListView.onLoadComplete();
                    ShowToast.show(getActivity(), "没有更多数据咯!");
                    break;
            }
        }
    };
    ...
    private void getRefreshData(String joke_id,int count){
        new GetJokesNet(joke_id, MyConfig.SCROLL_REFRESH, count,MyConfig.FRAGMENT_TYPE_JOKE,new GetJokesNet.SuccessGetJokeCallback() {
            @Override
...
//                    mListDatas=g.fromJson(data, new TypeToken<List<SingleJoke>>(){}.getType());
    ...
    private void getMoreData(String joke_id,int count){
        new GetJokesNet(joke_id, MyConfig.SCROLL_LOADINGMORE, count,MyConfig.FRAGMENT_TYPE_JOKE,new GetJokesNet.SuccessGetJokeCallback() {
            @Override
            public void onSuccess(String result) {
                String res= MyUtils.getGson(result,MyConfig.KEY_RESULT);
                if(res.equals(MyConfig.RESULT_SUCCESS)){
