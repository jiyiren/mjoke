...
public class LookActivity extends ListBaseActivity {
...
//        setContentView(R.layout.activity_look);
        tv_title.setText(R.string.personcenter_down_look);
    ...
    //提供外部进入该activity的方法
    public static void enterLookAty(Context context){
...
//                    ShowToast.show(LookActivity.this, "加载数据成功！");
                    break;
                case GET_MORE_DATA_FAIL:
                    mListView.onLoadComplete();
                    ShowToast.show(LookActivity.this, "暂无更多数据！");
                    break;
            }
        }
    };
    ...
    private void getMoreData(String joke_id,String token,int count){
        new GetUserAboutJokeNet(joke_id, token, count + "", MyConfig.USER_ABOUT_JOKE_TYPE_LOOK ,new GetUserAboutJokeNet.SuccessGetUserJokeCallback() {
            @Override
